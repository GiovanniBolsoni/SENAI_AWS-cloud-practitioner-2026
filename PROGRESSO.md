...
## 23/07/2026
- Criação de uma função **AWS Lambda** (`myStopinator`) em Python 3.11
- Configuração de gatilho no **Amazon EventBridge** (regra agendada, `rate(1 minute)`)
- Escrita do código da função usando **boto3** para parar instâncias EC2
